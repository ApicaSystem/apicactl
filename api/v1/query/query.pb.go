...
var file_api_proto_query_proto_rawDesc = []byte{
	...
	0x18, 0x01, 0x20, 0x03, 0x28, 0x09, 0x52, 0x06, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x73, 0x22, 0xe1,
	...
	0x6e, 0x12, 0x16, 0x0a, 0x06, 0x66, 0x61, 0x63, 0x65, 0x74, 0x73, 0x18, 0x0b, 0x20, 0x01, 0x28,
	0x08, 0x52, 0x06, 0x66, 0x61, 0x63, 0x65, 0x74, 0x73, 0x12, 0x26, 0x0a, 0x05, 0x71, 0x54, 0x79,
	0x70, 0x65, 0x18, 0x0c, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x10, 0x2e, 0x71, 0x75, 0x65, 0x72, 0x79,
	0x2e, 0x51, 0x75, 0x65, 0x72, 0x79, 0x54, 0x79, 0x70, 0x65, 0x52, 0x05, 0x71, 0x54, 0x79, 0x70,
	0x65, 0x1a, 0x4f, 0x0a, 0x0c, 0x46, 0x69, 0x6c, 0x74, 0x65, 0x72, 0x73, 0x45, 0x6e, 0x74, 0x72,
	...
	0x00, 0x12, 0x08, 0x0a, 0x04, 0x44, 0x45, 0x53, 0x43, 0x10, 0x01, 0x2a, 0x22, 0x0a, 0x09, 0x51,
	0x75, 0x65, 0x72, 0x79, 0x54, 0x79, 0x70, 0x65, 0x12, 0x0a, 0x0a, 0x06, 0x53, 0x65, 0x61, 0x72,
	0x63, 0x68, 0x10, 0x00, 0x12, 0x09, 0x0a, 0x05, 0x46, 0x65, 0x74, 0x63, 0x68, 0x10, 0x01, 0x32,
	0xf2, 0x03, 0x0a, 0x0c, 0x51, 0x75, 0x65, 0x72, 0x79, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65,
	...
	0x02, 0x0e, 0x22, 0x09, 0x2f, 0x76, 0x31, 0x2f, 0x71, 0x75, 0x65, 0x72, 0x79, 0x3a, 0x01, 0x2a,
	...
	0x76, 0x31, 0x2f, 0x64, 0x61, 0x74, 0x61, 0x2f, 0x7b, 0x71, 0x75, 0x65, 0x72, 0x79, 0x49, 0x64,
	0x7d, 0x2f, 0x6e, 0x65, 0x78, 0x74, 0x3a, 0x01, 0x2a, 0x12, 0x69, 0x0a, 0x10, 0x50, 0x6f, 0x73,
	...
	0xe4, 0x93, 0x02, 0x20, 0x22, 0x1b, 0x2f, 0x76, 0x31, 0x2f, 0x64, 0x61, 0x74, 0x61, 0x2f, 0x7b,
	0x71, 0x75, 0x65, 0x72, 0x79, 0x49, 0x64, 0x7d, 0x2f, 0x70, 0x72, 0x65, 0x76, 0x69, 0x6f, 0x75,
	0x73, 0x3a, 0x01, 0x2a, 0x42, 0xd3, 0x01, 0x5a, 0x2e, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e,
	0x63, 0x6f, 0x6d, 0x2f, 0x6c, 0x6f, 0x67, 0x69, 0x71, 0x61, 0x69, 0x2f, 0x6c, 0x6f, 0x67, 0x69,
	0x71, 0x63, 0x74, 0x6c, 0x2f, 0x61, 0x70, 0x69, 0x2f, 0x76, 0x31, 0x2f, 0x71, 0x75, 0x65, 0x72,
	0x79, 0x3b, 0x71, 0x75, 0x65, 0x72, 0x79, 0x92, 0x41, 0x9f, 0x01, 0x12, 0x0c, 0x0a, 0x05, 0x51,
	0x75, 0x65, 0x72, 0x79, 0x32, 0x03, 0x31, 0x2e, 0x30, 0x2a, 0x02, 0x01, 0x02, 0x32, 0x10, 0x61,
...
var file_api_proto_query_proto_depIdxs = []int32{
	...
	1,  // 3: query.QueryProperties.qType:type_name -> query.QueryType
	4,  // 4: query.GetDataRequest.facets:type_name -> query.Facet
	3,  // 5: query.GetDataResponse.data:type_name -> query.SysLogMessage
	4,  // 6: query.GetDataResponse.facets:type_name -> query.Facet
	10, // 7: query.GetQueryResponse.info:type_name -> query.QueryInfo
	11, // 8: query.GetQueryResponse.errors:type_name -> query.QueryErrors
	14, // 9: query.GetQueryResponse.meta:type_name -> query.GetQueryResponse.MetaEntry
	5,  // 10: query.QueryProperties.FiltersEntry.value:type_name -> query.FilterValues
	7,  // 11: query.QueryService.Query:input_type -> query.QueryProperties
	8,  // 12: query.QueryService.GetDataNext:input_type -> query.GetDataRequest
	8,  // 13: query.QueryService.GetDataPrevious:input_type -> query.GetDataRequest
	8,  // 14: query.QueryService.PostDataNext:input_type -> query.GetDataRequest
	8,  // 15: query.QueryService.PostDataPrevious:input_type -> query.GetDataRequest
	12, // 16: query.QueryService.Query:output_type -> query.GetQueryResponse
	9,  // 17: query.QueryService.GetDataNext:output_type -> query.GetDataResponse
	9,  // 18: query.QueryService.GetDataPrevious:output_type -> query.GetDataResponse
	9,  // 19: query.QueryService.PostDataNext:output_type -> query.GetDataResponse
	9,  // 20: query.QueryService.PostDataPrevious:output_type -> query.GetDataResponse
